...
function getVmobj(uuid, options, callback)
{
    ...
    if (options.loadManually) {
        //console.error('getVmobj loading manually - skipping vminfod');
        loadManually(callback);
    } else {
        // try Vminfod and fall back to manually loading
        //console.error('getVmobj loading using vminfod');
        loadVminfod(function (err, vm) {
            ...
            //console.error('getVmobj vminfod failure !!! - loading manually');
            //console.error(err);
            loadManually(callback);
        });
    }
...
function getVmobjs(filter, options, callback)
{
    ...
    if (options.loadManually) {
        //console.error('getVmobjs loading manually - skipping vminfod');
        loadManually(callback);
    } else {
        // try Vminfod and fall back to manually loading
        //console.error('getVmobjs loading using vminfod');
        loadVminfod(function (err, vms) {
            ...
            // emit a warning or error message here... vminfod failed
            //console.error('getVmobjs vminfod failure !!! - loading manually');
            //console.error(err);
            loadManually(callback);
        });
    }
